...
export const metadata = { title: 'Suppliers — FoodTaxi' }
...
export default async function SuppliersPage() {
  ...
  return (
    <DashboardShell businessName={business.name} activeHref="/dashboard/suppliers" title="Suppliers" subtitle="Supplier directory and purchase orders">
      <SuppliersDashboard />
    </DashboardShell>
  )
}
