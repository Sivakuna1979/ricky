...
import { BusinessMemory } from '@/components/memory/BusinessMemory'

export const dynamic = 'force-dynamic'
export const metadata = { title: 'Business Memory — FoodTaxi' }
...
export default async function MemoryPage() {
  ...
  return (
    <DashboardShell businessName={business.name} activeHref="/dashboard/memory" title="Business Memory" subtitle="Notes FoodTaxi AI can use as context">
      <BusinessMemory />
    </DashboardShell>
  )
}
