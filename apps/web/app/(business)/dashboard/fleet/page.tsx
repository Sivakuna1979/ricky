...
export const metadata = { title: 'Fleet — FoodTaxi' }
...
export default async function FleetPage() {
  ...
  return (
    <DashboardShell businessName={business.name} activeHref="/dashboard/fleet" title="Fleet" subtitle="Vehicles, equipment and maintenance">
      <FleetDashboard />
    </DashboardShell>
  )
}
