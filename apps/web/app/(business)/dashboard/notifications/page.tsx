...
export const metadata = { title: 'Notifications — FoodTaxi' }
...
export default async function NotificationsPage() {
  ...
  return (
    <DashboardShell businessName={business.name} activeHref="/dashboard/notifications" title="Notifications" subtitle="Everything FoodTaxi has flagged for you">
      <NotificationCentre />
    </DashboardShell>
  )
}
