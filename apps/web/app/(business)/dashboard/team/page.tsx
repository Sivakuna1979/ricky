...
export const metadata = { title: 'Team — FoodTaxi' }
...
export default async function TeamPage() {
  ...
  return (
    <DashboardShell businessName={business.name} activeHref="/dashboard/team" title="Team" subtitle="Staff, shifts, clock in/out and timesheets">
      <TeamDashboard />
    </DashboardShell>
  )
}
