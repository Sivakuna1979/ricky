...
export const metadata = { title: 'Stock — FoodTaxi' }
...
export default async function StockPage() {
  ...
  return (
    <DashboardShell businessName={business.name} activeHref="/dashboard/stock" title="Stock" subtitle="Catalogue, locations, stocktakes and wastage">
      <StockDashboard />
    </DashboardShell>
  )
}
